...
class BarcodeNumberGenerator:
    def __init__(self, yaml_file):
        with open(yaml_file, 'r') as stream:
            self.badge_types = yaml.load(stream) # TODO remove this for uber
    ...
    def generate_barcode_from_badge_num(badge_num, event_id, salt, key):
        ...
        encrypted_string = BarcodeNumberGenerator.encrypt(data_to_encrypt, key=key)
    ...
    def get_badge_num_from_barcode(barcode_num, salt, key):
        decrypted = BarcodeNumberGenerator.decrypt(barcode_num, key=key)
